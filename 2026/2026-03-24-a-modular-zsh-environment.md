...
Now all my supporting configuration files like, my history, my aliases, and my plugins are all neatly tucked away in an *XDG Base[^1]* compliant folder. It makes backing up my "dotfiles" or moving to a new machine much simpler.
